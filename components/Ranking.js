...
const Ranking = (props) => {
    ...
    // const stringData = props.scoreData.toString();
                    ...
                    <View style={styles.container}>
                        ...
                        props.scoreData.map((item, key) => 
                        {
                            ...
                            return <Animated.Text 
                                ...
                                key={item.id+item.name+item.score}>{key+1}位 {item.name}:<Text style={styles.words}>{item.score}</Text>
                                </Animated.Text>
